                    ...
                    <div>
                        <div
                            ...
                            <div class="search-input-group">
                                <div>
                                    <div>{!! __('car-search-bar.first-day') !!}</div>
                                    <div>{!! __('car-search-bar.pick-up-day') !!}</div>
                                </div>
...
<div class="md:hidden block px-11 py-8 text-lg font-sans-medium">
    <form>
        <div class="flex flex-col gap-2">
            <div class="search-input-group">
                <div>
                    <div>{!! __('car-search-bar.mobile-first-input-title') !!}</div>
                    <div>{!! __('car-search-bar.mobile-first-input-placeholder') !!}</div>
                </div>
                <input type="text" class="search-input" />
            </div>
            <button class="btn btn-red">{!! __('general.search') !!}</button>
