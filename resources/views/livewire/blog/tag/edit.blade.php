<div>
    @include('livewire.blog.tag.partial.create-edit', [
        'formTitle'         => __('Edit tag'),
        'formDescription'   => __('Edit the tag and then click on "Save"'),
        'formButton'        => __('Save'),
    ])
    ...
    <div class="mt-10">
        <x-admin.form-section submit="render">
            ...
            <x-slot name="description">
                {{ __('Click on the button to delete this tag') }}
            </x-slot>
