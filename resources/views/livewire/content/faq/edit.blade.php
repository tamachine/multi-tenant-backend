<div>
    ...
    >
        ...
        <div x-show="tab == 'basic'" style="display:none;">            
            @include('livewire.content.faq.partial.basic', ['faq' => $faq]) 

            @include('livewire.content.faq.partial.delete', ['faq' => $faq]) 
        </div>

        <div x-show="tab == 'translations'" style="display:none;">            
            @include('livewire.content.faq.partial.translations', ['faq' => $faq]) 
        </div>
    </div>    
</div>
