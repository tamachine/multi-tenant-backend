<x-admin-layout>
    ...
    <div x-show="tab == 'basic'" style="display:none;">
        <livewire:blog.category.edit :category="$category" />
    </div>

    <div x-show="tab == 'translations'" style="display:none;">
        <livewire:blog.category.translations :category="$category" />
    </div>

    <div x-show="tab == 'seo-configuration'" style="display:none;">
        <livewire:common.seo-configurations :instance="$category" />
    </div>
</x-admin-layout>
