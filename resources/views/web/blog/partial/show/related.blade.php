@if ($related) 
    <section>
        ...
        <div class="grid grid-rows-1 md:grid-cols-3 gap-10">
            ...
            <div class="rounded-2xl bg-cover h-[490px] w-full p-6 flex flex-col justify-end items-start text-white" style="background-image: url('{{ $blogPost->featured_image_url }}')">
