...
class AboutSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Translation::firstOrCreate(
            ...
            [
                'text' => ['en' => 'Why Iceland Cars', 'es' => '¿Por qué Iceland Cars?'],
            ]
        );
