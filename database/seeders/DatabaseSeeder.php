...
class DatabaseSeeder extends Seeder
{
    ...
    private function runStaging()
    {
        ...
        $this->call([
            ...
            FaqsSeeder::class,
            //FreeDaySeeder::class,
            IcelandCars\UserSeeder::class,
            IcelandCars\AffiliateSeeder::class,
            IcelandCars\VendorLocationSeeder::class,
            IcelandCars\CarSeeder::class,
            IcelandCars\ExtraSeeder::class,
