...
class AboutSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Translation::firstOrCreate(
            ...
            [
                'text' => ['en' => 'Why Cars Iceland?', 'es' => '¿Por qué Cars Iceland?'],
            ]
        );
