...
class BlogPost extends Model implements LocalizedUrlRoutable
{
    ...
    protected $apiResponse = ['hashid', 'title', 'published_at', 'summary', 'content', 'updated_at', 'hero', 'top', 'show_date', 'featured_image_path', 'featured_image_hover_path', 'featured_image_url', 'featured_image_hover_url', 'getFeaturedImageModelImageInstance', 'getFeaturedImageHoverModelImageInstance', 'author', 'category'];
