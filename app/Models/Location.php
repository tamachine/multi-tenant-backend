...
class Location extends Model
{
    ...
    protected $apiResponse = ['hashid', 'name', 'pickup_show_input', 'dropoff_show_input', 'pickup_input_require', 'dropoff_input_require', 'pickup_input_info', 'dropoff_input_info', 'getFeaturedImageModelImageInstance', 'caren_settings'];
