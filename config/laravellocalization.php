...
/**
 * These are the supported locales for mcnamara localization package which manage translated routes. 
 * If you comment or uncomment a language here, NOTICE that you should do it to config/languages.php as well
 */
